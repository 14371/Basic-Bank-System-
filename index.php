...
<html lang="en">
<head>
   <title>Zeone Bank - Sabka Saath Sabka Vinaash</title>
   <meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Zeone Bank  </a>
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="images/3.jpg" alt="Low interests" width="1100" height="500">
      <div class="carousel-caption">
...
<div  class="col-lg-6 col-md-6 col-12">
      ...
      <div  class="col-lg-6 col-md-6 col-12">
      <h1>Zeone Bank</h1>
      <p1> Zeone Bank is a part of Zeone foundation. It is one of Znations's leading private banks and was among the first to receive approval from the Central bank of Znation (CBZ) to set up a private sector bank in 992 ZY.
          Today, Zeone Bank has a banking network of 5,608 branches and 16,087 ATM's in 2,902 cities/towns. Zeone Bank offers a diverse range of financial products and banking services to customers(Which are dead actually, because they are ZEONE) through a growing branch and ATM network and digital channels such as Netbanking, Phonebanking and MobileBanking.
